  ...
  return (
    <div className="ancient-mystery-front-div">
      <Popup
        ...
        trigger={<figure className="ancient-mystery-front" id="AzathothMysteryFront3"></figure>}
        modal
        nested
      >
        {<div className="ancient-mystery-front-focus" id="AzathothMysteryFront3"></div>}
      </Popup>
