  ...
  return (
    <div className="ancient-mystery-front-div">
      <Popup
        ...
        trigger={<figure className="ancient-mystery-front" id="AzathothMysteryFront4"></figure>}
        modal
        nested
      >
        {<div className="ancient-mystery-front-focus" id="AzathothMysteryFront4"></div>}
      </Popup>
