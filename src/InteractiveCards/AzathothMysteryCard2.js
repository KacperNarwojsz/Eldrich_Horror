  ...
  return (
    <div className="ancient-mystery-front-div">
      <Popup
        ...
        trigger={<figure className="ancient-mystery-front" id="AzathothMysteryFront2"></figure>}
        modal
        nested
      >
        {<div className="ancient-mystery-front-focus" id="AzathothMysteryFront2"></div>}
      </Popup>
