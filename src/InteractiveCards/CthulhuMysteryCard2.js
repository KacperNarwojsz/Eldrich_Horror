  ...
  return (
    <div className="ancient-mystery-front-div">
      <Popup
        ...
        trigger={<figure className="ancient-mystery-front" id="CthulhuMysteryFront2"></figure>}
        modal
        nested
      >
        {<div className="ancient-mystery-front-focus" id="CthulhuMysteryFront2"></div>}
      </Popup>
