...
const ShubNiggurathMysteryCard2 = ({
  characters,
  mysteryDecrement,
  mysteryCounter,
  ...
  return (
    <div className="ancient-mystery-front-div">
      <Popup
        ...
        trigger={<figure className="ancient-mystery-front" id="ShubNiggurathMysteryFront2"></figure>}
        modal
        nested
      >
        {<div className="ancient-mystery-front-focus" id="ShubNiggurathMysteryFront2"></div>}
      </Popup>
