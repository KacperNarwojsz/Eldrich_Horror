...
const ShubNiggurathMysteryCard4 = ({
  characters,
  ...
  return (
    <div className="ancient-mystery-front-div">
      <Popup
        ...
        trigger={<figure className="ancient-mystery-front" id="ShubNiggurathMysteryFront4"></figure>}
        modal
        nested
      >
        {<div className="ancient-mystery-front-focus" id="ShubNiggurathMysteryFront4"></div>}
      </Popup>
      <div>
        <div className="mystery-tokens-monster-div">
          <button className="mystery-monster" id={monsterSlayed ? 'TokenNugSlayed' : 'TokenNug'}></button>
