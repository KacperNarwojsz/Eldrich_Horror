  ...
  return (
    <div className="ancient-mystery-front-div">
      <Popup
        ...
        trigger={<figure className="ancient-mystery-front" id="CthulhuMysteryFront1"></figure>}
        modal
        nested
      >
        {<div className="ancient-mystery-front-focus" id="CthulhuMysteryFront1"></div>}
      </Popup>
