...
const ShubNiggurathMysteryCard1 = ({
  characters,
  mysteryDecrement,
  mysteryCounter,
  ...
  return (
    <div className="ancient-mystery-front-div">
      <Popup
        ...
        trigger={<figure className="ancient-mystery-front" id="ShubNiggurathMysteryFront1"></figure>}
        modal
        nested
      >
        {<div className="ancient-mystery-front-focus" id="ShubNiggurathMysteryFront1"></div>}
      </Popup>
      <div className="mystery-tokens-div">
        <div className="mystery-counter">
          ...
          <button className="token-mystery-eldritch"></button>
