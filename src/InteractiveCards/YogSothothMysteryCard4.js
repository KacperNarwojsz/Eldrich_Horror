  ...
  return (
    <div className="ancient-mystery-front-div">
      <Popup
        ...
        trigger={<figure className="ancient-mystery-front" id="YogSothothMysteryFront4"></figure>}
        modal
        nested
      >
        {<div className="ancient-mystery-front-focus" id="YogSothothMysteryFront4"></div>}
      </Popup>
      <div>
        <div className="mystery-tokens-monster-div">
          <button
            className="mystery-monster"
            id={monsterSlayed ? 'TokenDunwichHorrorSlayed' : 'TokenDunwichHorror'}
          ></button>
