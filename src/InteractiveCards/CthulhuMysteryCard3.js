  ...
  return (
    <div className="ancient-mystery-front-div">
      <Popup
        ...
        trigger={<figure className="ancient-mystery-front" id="CthulhuMysteryFront3"></figure>}
        modal
        nested
      >
        {<div className="ancient-mystery-front-focus" id="CthulhuMysteryFront3"></div>}
      </Popup>
