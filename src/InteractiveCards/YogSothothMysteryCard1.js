  ...
  return (
    <div className="ancient-mystery-front-div">
      <Popup
        ...
        trigger={<figure className="ancient-mystery-front" id="YogSothothMysteryFront1"></figure>}
        modal
        nested
      >
        {<div className="ancient-mystery-front-focus" id="YogSothothMysteryFront1"></div>}
      </Popup>
