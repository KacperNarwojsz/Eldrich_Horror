  ...
  return (
    <div className="ancient-mystery-front-div">
      <Popup
        ...
        trigger={<figure className="ancient-mystery-front" id="AzathothMysteryFront1"></figure>}
        modal
        nested
      >
        {<div className="ancient-mystery-front-focus" id="AzathothMysteryFront1"></div>}
      </Popup>
