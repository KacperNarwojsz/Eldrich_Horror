      ...
      <div className="ancient-mystery">
        ...
        {this.props.isMystery1Active ? (
          <CthulhuMysteryCard1
            ...
            mysteryDone={
              this.props.ancientCardFlipped && this.mysteryDeck.length === 0 ? this.cthulhuAwakening : this.mysteryDone
            }
          />
        ) : null}
        ...
        {this.props.isCthulhuAwake ? (
          <CthulhuMysteryRise characters={this.props.characters} cthulhuSlayed={this.props.victory} />
        ) : null}
      </div>
    );
  }
